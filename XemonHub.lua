...
local serv = win:Server("Xemon HUB","")
...
function CheckLevel()
	...
	if Three_World then
        ...
        elseif Lv == 2075 or Lv <= 2099 or SelectMonster == "Peanut Scout [Lv. 2075]" then
			...
			CFrameQ = CFrame.new(-2102.582763671875, 38.12920379638672, -10191.7568359375)
			CFrameMon = CFrame.new(-2241.2587890625, 38.12986755371094, -10214.6923828125)
		elseif Lv == 2100 or Lv <= 2124 or SelectMonster == "Peanut President [Lv. 2100]" then
			Ms = "Peanut President [Lv. 2100]"
			NameQuest = "NutsIslandQuest"
			QuestLv = 2
			NameMon = "Peanut President"
			CFrameQ = CFrame.new(-2101.7373046875, 38.12901306152344, -10191.107421875)
			CFrameMon = CFrame.new(-2290.9228515625, 88.26529693603516, -10420.1533203125)
		elseif Lv == 2125 or Lv <= 2149 or SelectMonster == "Ice Cream Chef [Lv. 2125]" then
			Ms = "Ice Cream Chef [Lv. 2125]"
			NameQuest = "IceCreamIslandQuest"
			QuestLv = 1
			NameMon = "Ice Cream Chef"
            CFrameQ = CFrame.new(-823.4407958984375, 65.84532165527344, -10962.724609375)
			CFrameMon = CFrame.new(-773.65771484375, 65.84529113769531, -10919.9443359375)
		elseif Lv == 2150 or Lv <= 2199 or SelectMonster == "Ice Cream Commander [Lv. 2150]" then
			Ms = "Ice Cream Commander [Lv. 2150]"
			NameQuest = "IceCreamIslandQuest"
			QuestLv = 2
			NameMon = "Ice Cream Commander"
			CFrameQ = CFrame.new(-823.5824584960938, 65.84532928466797, -10962.90234375)
			CFrameMon = CFrame.new(-626.6090087890625, 126.89688873291016, -11139.5078125)
		elseif Lv == 2200 or Lv <= 2224 or SelectMonster == "Cookie Crafter [Lv. 2200]" then
		    Ms = "Cookie Crafter [Lv. 2200]"
			NameQuest = "CakeQuest1"
			QuestLv = 1
			NameMon = "Cookie Crafter"
			CFrameQ = CFrame.new(-2019.6910400390625, 37.824012756347656, -12026.0498046875) 
			CFrameMon = CFrame.new(-2212.679931640625, 37.82398223876953, -12082.6171875)
	    elseif Lv == 2225 or Lv <= 2249 or SelectMonster == "Cake Guard [Lv. 2225]" then
			...
			NameMon = "Cake Guard"
			CFrameQ = CFrame.new(-2019.6910400390625, 37.824012756347656, -12026.0498046875)
			CFrameMon = CFrame.new(-1632.49072265625, 37.818023681640625, -12127.3408203125)
	    elseif Lv == 2250 or Lv <= 2274 or SelectMonster == "Baking Staff [Lv. 2250]" then
		    Ms = "Baking Staff [Lv. 2250]"
			NameQuest = "CakeQuest2"
			QuestLv = 1
			NameMon = "Baking Staff"
			CFrameQ = CFrame.new(-1927.63232421875, 37.82392501831055, -12842.8271484375)
			CFrameMon = CFrame.new(-1819.971435546875, 37.82398986816406, -12889.513671875)
	    elseif Lv == 2275 or Lv <= 2300 or SelectMonster == "Head Baker [Lv. 2275]" then
		    Ms = "Head Baker [Lv. 2275]"
			NameQuest = "CakeQuest2"
			QuestLv = 2
			NameMon = "Head Baker"
			CFrameQ = CFrame.new(-1926.551513671875, 37.82392501831055, -12844.142578125)
			CFrameMon = CFrame.new(-2116.564453125, 53.42386245727539, -13000.2822265625)
		end
	end
end
